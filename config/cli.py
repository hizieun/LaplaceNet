...
def create_parser():
    ...
    parser.add_argument('--data-ver', type=str, default='D', help='model version, D, S, R')
    parser.add_argument('--datadir', type=str, default='d_tranform', help='dataset directory')
